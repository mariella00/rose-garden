...
if(isset($_POST['go']))
{
    ...
    $query = "SELECT * FROM plant_products WHERE plant_name LIKE '%$search%'";
    $search_result = filterTable($query);
       $queryResult = mysqli_num_rows($search_result);
    }
 else {
    $query = "SELECT * FROM plant_products";
    $search_result = filterTable($query);
  ...
  <!--SEARCH----------------->
      <form method="post" action="plants.php">
            <div class="search-box">
                <input class="search-txt" type="text" name="search" placeholder="Search in plants">
      ...
      <div class="product-container">
        <input type="hidden" name="id" value="<?php echo $row['plant_id']; ?>">
          <div class="card">
            ...
            <div class="image">
              <a href="plant_description.php?next=<?php echo $row['plant_id']; ?>">
                  <img src="<?php echo $row['plant_image']; ?>">
              </a> 
            </div>
            <div>
            <a href="plant_description.php?next=<?php echo $row['plant_id']; ?>" style="text-decoration: none;  color: black;">
