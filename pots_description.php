...
<nav> 
  ...
  <div class="product-description">
    ...
    <div class="product-des">
      <strong>&nbsp;Size:</strong></span> <?php echo $row['pots_size']; ?>
       <table style="empty-cells: hide;" >
       <tr>
         <th class="row-td">Color</th>
         <th class="row-td">Stocks</th>
       </tr>
       <tr>
      
         <td class="row-td"><?php if ($row['pots_color1'] != "") {
           echo $row['pots_color1'];
         }  ?></td> 
       
          <td class="row-td"><?php if ($row['pots_stocks1'] != '0') {
            echo $row['pots_stocks1'];
          }  ?></td>
       </tr>
        <tr>
         <td class="row-td"><?php if ($row['pots_color2'] != "") {
           echo $row['pots_color2']; 
         } ?></td>
          <td class="row-td"><?php if ($row['pots_stocks2'] != '0') {
            echo $row['pots_stocks2']; 
          } ?></td>
       </tr>
        <tr>
         <td class="row-td"><?php if ($row['pots_color3'] != "") {
           echo $row['pots_color3'];
         }  ?></td>
          <td class="row-td"><?php if ($row['pots_stocks3'] != '0') {
            echo $row['pots_stocks3'];
          }  ?></td>
       </tr>
