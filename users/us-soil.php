...
<!-- Soil Menu------------------------------------ -->
<?php $results = mysqli_query($conn, "SELECT * from soil_products "); ?>
      ...
      <div class="product-container">
        <input type="hidden" name="id" value="<?php echo $row['soil_id']; ?>">
          <div class="card">
            ...
            <div class="image">
              <a href="us-soil-desc.php?next=<?php echo $row['soil_id']; ?>">
                  <img src="../<?php echo $row['soil_image']; ?>">
              </a> 
            </div>
            <div>
            <a href="us-soil-desc.php?next=<?php echo $row['soil_id']; ?>" style="text-decoration: none;  color: black;">
